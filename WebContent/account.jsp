...
<%@ page import="java.util.Collection, java.util.Iterator, java.math.BigDecimal, com.ibm.websphere.samples.trade.*, com.ibm.websphere.samples.trade.util.*" session="true" isThreadSafe="true" isErrorPage="false"%>
<jsp:useBean id="results" scope="request" type="java.lang.String" />
<jsp:useBean id="accountData" type="com.ibm.websphere.samples.trade.AccountDataBean" scope="request" />
<jsp:useBean id="accountProfileData" type="com.ibm.websphere.samples.trade.AccountProfileDataBean" scope="request"/>
