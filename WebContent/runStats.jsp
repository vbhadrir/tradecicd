...
<%@ page import="com.ibm.websphere.samples.trade.*" session="false" isThreadSafe="true" isErrorPage="false" %>

<jsp:useBean class="com.ibm.websphere.samples.trade.RunStatsDataBean" id="runStatsData" scope="request" />
<% 
