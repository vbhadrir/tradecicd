...
<%@ page import="com.ibm.websphere.samples.trade.TradeConfig" session="false" isThreadSafe="true" isErrorPage="false" %>
...
<TABLE border="1" width="614">
	<TBODY>
		...
		<TR>
			<TD colspan="2">
				<B>DB Connection Properties</B>
				<br> 
				<input type="radio" name="JDBC_DRIVER_TYPE" value="DB2" checked	>DB2
				<input type="radio" name="JDBC_DRIVER_TYPE" value="MySQL"		>MySQL
				<input type="radio" name="JDBC_DRIVER_TYPE" value="PostgreSQL"	>PostgreSQL
				
				<br><%=(TradeConfig.VCAP_MSG == null) ? "" : TradeConfig.VCAP_MSG%>
				<br>URL:<INPUT name="DS_NAME" size="120" type="text"
				  value='<%=(TradeConfig.DS_NAME == null) ? "" : TradeConfig.DS_NAME %>'>
				<br>UserID:<INPUT name="JDBC_UID" size="120" type="text"
				  value='<%=(TradeConfig.JDBC_UID == null) ? "" : TradeConfig.JDBC_UID %>'>
				<br>Password:<INPUT name="JDBC_PWD" size="120" type="text"
				  value='<%=(TradeConfig.JDBC_PWD == null) ? "" : TradeConfig.JDBC_PWD %>'>    
			</TD>
		</TR>		
