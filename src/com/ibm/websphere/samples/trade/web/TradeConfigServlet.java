...
package com.ibm.websphere.samples.trade.web;

import javax.servlet.*;
import javax.servlet.http.*;
import java.io.IOException;
import com.ibm.websphere.samples.trade.*;
import com.ibm.websphere.samples.trade.direct.TradeDirect;
...
public class TradeConfigServlet extends HttpServlet {
	...
	*/
	...
	void doConfigUpdate(HttpServletRequest req, HttpServletResponse resp) throws Exception 
	{
		...
		// Process DB Binding information
		String dbURL 		= req.getParameter("DS_NAME");
		String dbUserId 	= req.getParameter("JDBC_UID");
		String dbPassword 	= req.getParameter("JDBC_PWD");
		if(dbURL != null) 		TradeConfig.DS_NAME = dbURL;
		if(dbUserId != null)	TradeConfig.JDBC_UID = dbUserId;
		if(dbPassword != null) 	TradeConfig.JDBC_PWD = dbPassword;
		currentConfigStr += "...DS_NAME:" + TradeConfig.DS_NAME  + 
		"\n...JDBC_UID:" + TradeConfig.JDBC_UID + 
		"\n...JDBC_UID:" + TradeConfig.JDBC_PWD + "\n";		
			
		// process RunTimeMode indicator
