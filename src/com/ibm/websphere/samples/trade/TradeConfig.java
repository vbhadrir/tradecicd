...
public class TradeConfig 
{
	...
	// For connecting to postgres
 	//public static String JDBC_UID = "wdhdskih";
	//public static String JDBC_PWD = "auumra97m11kSgJRu45D15z2yZG26u9d";
	//public static String DS_NAME  = "jdbc:postgresql://babar.elephantsql.com:5432/wdhdskih";
	
	// For connecting to mySQL DB, populated from VCAP_SERVICES if possible
	// jdbc:mysql://b0fdd129294ed5:f7404129@us-cdbr-iron-east-02.cleardb.net:3306/ad_81f61341da67658
 	public static String VCAP_MSG = "n/a";
 	
 	private static final String _postgresqlDriverClass = "org.postgresql.Driver";
 	private static final String _mysqlDriverClass = "com.mysql.jdbc.Driver";
 	private static final String _db2DriverClass = "com.ibm.db2.jcc.DB2Driver";
 	public static String JDBC_DRIVER_CLASS = _postgresqlDriverClass;
 	
	public static String DS_NAME  = "jdbc:postgresql://10.1.0.50:5432/tradedb";
 	public static String JDBC_UID = "inst1";
	public static String JDBC_PWD = "passw0rd";
	...
	public static int workloadMix = SCENARIOMIX_HIGHVOLUME;
